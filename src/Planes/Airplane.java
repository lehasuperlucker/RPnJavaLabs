...
// создать иерархию: базовый самолет -> типа кукурузники, пассажирские самолёты, грузовые самолеты. Подумать
// над использованием интерфейсов. Создать класс авиакомпании, полями которого будут его имя и список объектов
// класса Plane, при инициализации авиакомпании скастить объекты к базоовому типу. В классы добавить get set методы
// для получения доступа к закрытым полям классов.
